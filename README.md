...
1. Export/download verified historical daily AQI data from CPCB/WBPCB for the selected station.
...
Keep the original export and a source log with URL, station identifier, download date, unit, AQI standard, and any data transformation. Raw and processed data are deliberately excluded from Git to avoid publishing unverified or restricted data.
